...
public class DateTimeUtil {
    ...
    public static String getFormattedDateTimeSinceFormat(LocalDateTime dateTime) {
        return (dateTime == null ? null : dateTime.format(SINCE_FORMATE));
    }
    public static LocalDateTime getSriLankaTimes() {
        LocalDateTime localDateTime = LocalDateTime.now();
        String dateTime = SINCE_FORMATE.format(localDateTime);
        return getFormattedDateTimes(dateTime);
    }

    public static LocalDateTime getFormattedDateTimes(String dateTime) {
        LocalDateTime localDateTime = null;
        try {
            localDateTime = LocalDateTime.parse(dateTime, SINCE_FORMATE);
        } catch (Exception e) {
        }
        return (localDateTime);
    }
